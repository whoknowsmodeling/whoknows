  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${inter.variable} ${playfair.variable}`}>
      <head>
        ...
        <link rel="preconnect" href="https://vonnnlywftnpmlsupace.supabase.co" crossOrigin="anonymous" />
        <link rel="dns-prefetch" href="https://vonnnlywftnpmlsupace.supabase.co" />
        <script
